...
const schedule = [
  { day: 'MONDAY', clubs: ['Podcast'], centres: ['Centre for Smart Manufacturing'] },
  { day: 'TUESDAY', clubs: ['STEAM'], centres: ['Center for EV & Energy'] },
  { day: 'WEDNESDAY', clubs: ['Fusion', 'Nippon'], centres: ['Centre For Image Processing', 'Sports'] },
  { day: 'THURSDAY', clubs: ['Mediastic Hub'], centres: ['Center for Space'] },
  { day: 'FRIDAY', clubs: ['UBA', 'Rotaract'], centres: ['Centre for RADAR'] },
];

async function seedB204() {
  console.log('Inserting independent slots for B2-04...');
  
  const clubNameMap: Record<string, string> = {
    'Podcast': 'Podcast (PODX)',
